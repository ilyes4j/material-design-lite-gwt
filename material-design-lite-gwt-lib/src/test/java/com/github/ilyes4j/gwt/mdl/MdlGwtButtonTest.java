...
public class MdlGwtButtonTest extends MdlGwtBaseTest {
  ...
  public final void testBreakingChange() {
    ...
    // checking builders
    Button.createFab(FAB_NO_COLOR, HAS_RIPPLE, "add");
    Button.createFlat(ACCENT, HAS_RIPPLE, "button");
    Button.createIcon(ACCENT, HAS_RIPPLE, "add");
    Button.createMiniFab(FAB_NO_COLOR, HAS_RIPPLE, "add");
    ...
    //checking fab colors
    ButtonFabColor fabclr;
    fabclr = ButtonFabColor.COLORED;
    fabclr = ButtonFabColor.FAB_NO_COLOR;   
    btn.setFabColor(fabclr);
